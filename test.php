...
<head>
    ...
    <title>bootstrap-datetimepicker with Bootstrap 4</title>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="https://github.com/monim67/bootstrap-datetimepicker">
            <svg class="navbar-nav-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 499.36" focusable="false" style="height: 1rem; width: 1rem;">
                <title>monim67/bootstrap-datetimepicker on Github</title>
        ...
        <div class="collapse navbar-collapse" id="navbarText">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link" href="./">Demo with Bootstrap 3</a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" href="#">Demo with Bootstrap 4
                ...
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group date" id="id_3">
                            <input type="text" name="end_time" value="11:31:00" class="form-control" placeholder="End time" title="" required id="id_end_time"/>
                            <div class="input-group-addon input-group-append">
                                <div class="input-group-text">
                                    <i class="glyphicon glyphicon-time fa fa-clock-o"></i>
                                </div>
